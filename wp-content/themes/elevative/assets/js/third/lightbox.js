...
$j( document ).on( 'ready', function() {
    "use strict";
    // Auto lightbox
    elevativeAutoLightbox();
    // Lightbox
    elevativeInitLightbox();
} );

/* ==============================================
AUTO LIGHTBOX
============================================== */
function elevativeAutoLightbox() {
    "use strict"
    ...
    $j( 'body .entry-content a:has(img), body .entry a:has(img)' ).each( function() {
        ...
        if ( ! $j( this ).hasClass( 'no-lightbox' )
            ...
            $j( this ).addClass( 'elevative-lightbox' );
...
LIGHTBOX
============================================== */
function elevativeInitLightbox( $context ) {
    "use strict"

    // Lightbox
    $j( '.elevative-lightbox' ).magnificPopup( {
        type: 'image',
