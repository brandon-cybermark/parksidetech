<section class="gallery_3 section__wrapper">
	<span class="h6 section__title">Gallery 3</span>
	<div class="container">
		<div class="section__container columns gallery_columns">
			<div class="gallery__slider">
				<?php $gallery = get_sub_field('gallery_items');
				foreach( $gallery as $gallery_slide ): ?>
				<div class="gallery__item ml-1 mr-1">
					<div class="column gallery_3_column mb-0">
						<div class="column-img mb-0">
							<a href="<?php echo wp_get_attachment_url($gallery_slide); ?>" class="fancybox" rel="gallery3">
