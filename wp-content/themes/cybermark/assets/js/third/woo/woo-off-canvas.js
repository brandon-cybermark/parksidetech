...
$j( document ).on( 'ready', function() {
	"use strict";
    // Woo off canvas
    cybermarkWooOffCanvas();
} );

/* ==============================================
WOOCOMMERCE OFF CANVAS
============================================== */
function cybermarkWooOffCanvas() {
	"use strict"

	$j( document ).on( 'click', '.cybermark-off-canvas-filter', function( e ) {
		e.preventDefault();
	...
	$j( '.cybermark-off-canvas-overlay' ).on( 'click', function() {
		$j( 'html' ).css( {
			'overflow': '',
			'margin-right': '' 
		} );
