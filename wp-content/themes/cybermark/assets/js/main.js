            ...
            bannerHTML:
                  '<div class="popup">'
                    + '<div class="row align-items-center">'
                      + '<div class="col-md-6 col-lg-8 text-center">Just a quick heads up: We use cookies on our site to enhance your experience.'
                      + '</div>'
                      + '<div class="col-md-6 col-lg-4 text-center">'
                        + '<a href="#" class="btn primary-btn mr-1 ce-accept" >'
                        + 'Okay'
                        + '</a>'
                        + '<a href="/privacy-policy/" target="_blank" rel="nofollow" class="btn secondary-btn">Learn More</a>'
                      + '</div>'
                    + '</div>'
                  + '</div>',
