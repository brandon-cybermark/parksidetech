...
$j( document ).on( 'ready', function() {
	...
	cybermarkFullScreenMenu();
} );

/* ==============================================
FULL SCREEN MENU
============================================== */
function cybermarkFullScreenMenu() {
	"use strict"
	...
	if ( $menuBar.length ) {
		...
		// Open menu function
		var cybermarkFullScreenMenuOpen = function() {
		...
		// Close menu function
		var cybermarkFullScreenMenuClose = function() {
		...
		$menuBar.on( 'click', function( e ) {
			...
			if ( ! $j( this ).hasClass( 'exit' ) ) {
				cybermarkFullScreenMenuOpen();
	        } else {
	        	cybermarkFullScreenMenuClose();
	        }
