...
$j( document ).on( 'ready', function() {
	...
	elevativeFullScreenMenu();
} );

/* ==============================================
FULL SCREEN MENU
============================================== */
function elevativeFullScreenMenu() {
	"use strict"
	...
	if ( $menuBar.length ) {
		...
		// Open menu function
		var elevativeFullScreenMenuOpen = function() {
		...
		// Close menu function
		var elevativeFullScreenMenuClose = function() {
		...
		$menuBar.on( 'click', function( e ) {
			...
			if ( ! $j( this ).hasClass( 'exit' ) ) {
				elevativeFullScreenMenuOpen();
	        } else {
	        	elevativeFullScreenMenuClose();
	        }
