 ...
 */
function elevative_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Elevative default saturation level.
	 *
	 * @since Elevative 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation         = absint( apply_filters( 'elevative_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.elevative-front-page) .entry-title,
...
.colors-custom .elevative-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.elevative-front-page .panel-content .recent-posts article,
...
.colors-custom.elevative-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Elevative custom colors CSS.
	 *
	 * @since Elevative 1.0
	 *
	 ...
	 */
	return apply_filters( 'elevative_custom_colors_css', $css, $hue, $saturation );
}
