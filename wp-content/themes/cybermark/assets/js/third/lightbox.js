...
$j( document ).on( 'ready', function() {
    "use strict";
    // Auto lightbox
    cybermarkAutoLightbox();
    // Lightbox
    cybermarkInitLightbox();
} );

/* ==============================================
AUTO LIGHTBOX
============================================== */
function cybermarkAutoLightbox() {
    "use strict"
    ...
    $j( 'body .entry-content a:has(img), body .entry a:has(img)' ).each( function() {
        ...
        if ( ! $j( this ).hasClass( 'no-lightbox' )
            ...
            $j( this ).addClass( 'cybermark-lightbox' );
...
LIGHTBOX
============================================== */
function cybermarkInitLightbox( $context ) {
    "use strict"

    // Lightbox
    $j( '.cybermark-lightbox' ).magnificPopup( {
        type: 'image',
