 ...
 */
function cybermark_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter CyberMark default saturation level.
	 *
	 * @since CyberMark 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation         = absint( apply_filters( 'cybermark_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.cybermark-front-page) .entry-title,
...
.colors-custom .cybermark-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.cybermark-front-page .panel-content .recent-posts article,
...
.colors-custom.cybermark-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters CyberMark custom colors CSS.
	 *
	 * @since CyberMark 1.0
	 *
	 ...
	 */
	return apply_filters( 'cybermark_custom_colors_css', $css, $hue, $saturation );
}
