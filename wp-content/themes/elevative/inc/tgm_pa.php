...
add_action( 'tgmpa_register', 'elevative_register_required_plugins' );

/**
 * Register the required plugins for this theme.
 */
function elevative_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'               => 'Elevative Plugin', // The plugin name.
			'slug'               => 'elevative-plugin', // The plugin slug (typically the folder name).
			'source'             => get_template_directory() . '/lib/plugins/elevative-plugin.zip', // The plugin source.
			'required'           => true, 
			'version'            => '2.0.0', 
			'force_activation'   => true, 
			'force_deactivation' => true, 
	 ...
	 */
	$config = array(
		'id'           => 'elevative',                 // Unique ID for hashing notices for multiple instances of TGMPA.
