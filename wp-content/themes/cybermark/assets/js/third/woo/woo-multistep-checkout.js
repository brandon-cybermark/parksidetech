...
$j( document ).on( 'ready', function() {
    ...
    cybermarkWooMultiStepCheckout();
} );

/* ==============================================
WOOCOMMERCE MULTI-STEP CHECKOUT
============================================== */
function cybermarkWooMultiStepCheckout() {
	"use strict"
    ...
    form_actions.find( '.button.prev' ).add( '.button.next' ).on( 'click', function( e ) {
        var $this 			= $j( this ),
            ...
            is_logged_in    = cybermarkLocalize.is_logged_in,
            button_title,
            valid           = false,
        ...
        if ( true == cybermarkLocalize.hasStickyTopBar ) {
        ...
        if ( type == 'billing' || type == 'shipping' ) {
            ...
            var data = {
                action: 'cybermark_validate_checkout',
                type: type,
        ...
        if ( valid ) {
            ...
            if ( ( current_step == 1
                ...
                ( is_logged_in == false
                	&& ( ( current_step == 0
                		&& cybermarkLocalize.login_reminder_enabled == 1 )
                	||  ( current_step == 1
                		&& cybermarkLocalize.login_reminder_enabled == 0 ) ) ) ) {
                prev.fadeOut( 120 );
            } else {
                prev.fadeIn( 120 );
            }
            ...
            if ( is_logged_in == false
                && ( ( current_step == 0
                    ...
                    ||  ( current_step == 1
                        && cybermarkLocalize.login_reminder_enabled == 0 ) )  ) {
                next.val( cybermarkLocalize.no_account_btn );
            } else {
                next.val( cybermarkLocalize.next );
            }
