...
$j( document ).on( 'ready', function() {
	"use strict";
	// Scroll effect
	cybermarkScrollEffect();
} );

/* ==============================================
SCROLL EFFECT
============================================== */
function cybermarkScrollEffect() {
	"use strict"
	    ...
	    $j( 'a.local[href*="#"]:not([href="#"]), .local a[href*="#"]:not([href="#"]), a.menu-link[href*="#"]:not([href="#"]), a.sidr-class-menu-link[href*="#"]:not([href="#"])' ).on( 'click', function() {
	    	...
	    	if ( ! $j( this ).hasClass( 'omw-open-modal' )
	        	...
	        	var $href     				= $j( this ).attr( 'href' ),
				    ...
				    $target   				= $j( '#' + $hrefHash ),
					$adminbarHeight        	= cybermarkGetAdminbarHeight(),
					$topbarHeight        	= cybermarkGetTopbarHeight(),
					$stickyHeaderHeight    	= cybermarkGetStickyHeaderHeight(),
...
// Admin bar height
function cybermarkGetAdminbarHeight() {
	"use strict"
...
// Top bar height
function cybermarkGetTopbarHeight() {
	"use strict"
...
// Header height
function cybermarkGetStickyHeaderHeight() {
	"use strict"
